...
var TOPIC_SUB_OPTIONS = {
  ...
  '廣告規格': [
    ...
    '關鍵字橫幅廣告 Keyword Search Banner 規格',
    '我的清單橫幅廣告 My List Banner 規格',
    '焦點精選 Featured Wall 規格',
    '熱門搜尋直幅廣告 Hot Search Banner 規格',
    '加單貨品橫幅廣告 Add On Banner 規格',
    '排行榜橫幅廣告 Leaderboard Banner 規格',
    '贊助廣告貨品標誌 Product Sponsorship Icon 規格',
    '專屬優惠券 My Page Coupon 規格',
    '貨品贊助清單 Main Page Sponsor Box 規格',
    '貨品推廣組合 Advance Promotion Box 規格',
    'VIP 廣告貨品 VIP Sponsored Product 規格',
    '購物車推薦 Cart Recommendation 規格',
    '手機推播訊息 App Notification 規格',
    'Facebook 推廣帖子規格',
    'Instagram 推廣帖子及限時動態規格',
    '皇牌橫幅廣告 Hero Slider 規格（時尚服飾）',
    '本週人氣店 Weekly Best Store 規格（時尚服飾）',
    '焦點精選 Featured Wall 規格（時尚服飾）',
    '廣告圖片格式通用要求'
  ],
  '圖片規格': [
    '廣告圖片格式通用要求',
